...
function fuseAbilities(headAbilities, bodyAbilities) {
...
function fuseStats(headStats, bodyStats){
...
function fuseTypes(head, body) {
	...
	for (var pokemon in swappedTypes) {
		if (toID(head.species) === pokemon) {
			headType = swappedTypes[pokemon];
		}
		if (toID(body.species) === pokemon) {
